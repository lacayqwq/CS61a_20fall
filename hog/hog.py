...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    if GCD(player_score, opponent_score) >=10: return True
    else: return False
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if player_score < opponent_score and player_score > opponent_score - 3: return True
    else: return False
    # END PROBLEM 4b
        ...
        if who == 0:
            ...
            if score1 - last_score > running_high:
                print(score1 - last_score, \
                    "point(s)! The most yet for Player 1")
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    f_sc = score + free_bacon(opponent_score)
    if pig_pass(f_sc, opponent_score) or swine_align(f_sc, opponent_score): return 0
    else: return bacon_strategy(score, opponent_score, cutoff, num_rolls)  # Replace this statement
    # END PROBLEM 11
